...
export function LaravelLogo(props: any) {
  return (
...
export function TupleLogo(props: any) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function TransistorLogo(props: any) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function DiageoLogo(props: any) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="#fff"
...
export function StaticKitLogo(props: any) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function StatamicLogo(props: any) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function MirageLogo(props: any) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function ReversableLogo(props: any) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"
...
export function DeviceArrowIcon(props: any) {
  return (
...
export function DeviceCardsIcon(props: any) {
  let id = useId();
...
export function DeviceClockIcon(props: any) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceListIcon(props: any) {
  return (
...
export function DeviceLockIcon(props: any) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceChartIcon(props: any) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
